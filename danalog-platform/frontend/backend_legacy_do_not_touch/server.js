...
const DEFAULT_ROUTES = [
    ...
    {
        "id": "RT-EXTRA-016",
        "routeName": "Tiên Sa->Danalog 1 cont có hàng",
        "customer": "VANTUONG",
        "cargoType": "VC_CONT",
        "isNightStay": false,
        "revenue": {
    ...
    {
        "id": "RT-EXTRA-023",
        "routeName": "Đi xe từ Danalog-> Chu Lai làm hàng nhập HYSO ở lại đến ngày 14/03 về Danalog",
        "customer": "QZY",
        "cargoType": "VC_CONT",
        "isNightStay": false,
        "revenue": {
    ...
    {
        "id": "RT-EXTRA-024",
        "routeName": "Danalog - Viconship Hòa Cầm -Sửa xe",
        "customer": "HYOSUNG",
        "cargoType": "VC_CONT",
        "isNightStay": false,
        "revenue": {
    ...
    {
        "id": "RT-EXTRA-026",
        "routeName": "Danalog - Viconship Hòa Cầm (đăng kiểm bị từ chối về thay lốp)",
        "customer": "AST",
        "cargoType": "VC_CONT",
        "isNightStay": false,
        "revenue": {
    ...
    {
        "id": "RT-EXTRA-027",
        "routeName": "Danalog - Hòa Châu đăng kiểm",
        "customer": "HYOSUNG",
        "cargoType": "VC_CONT",
        "isNightStay": false,
        "revenue": {
    ...
    {
        "id": "RT-EXTRA-028",
        "routeName": "Hòa Nhơn - Danalog 1 lấy mooc",
        "customer": "AST",
        "cargoType": "VC_CONT",
        "isNightStay": false,
        "revenue": {
    ...
    {
        "id": "RT-EXTRA-031",
        "routeName": "Kéo rỗng 40’hc  từ Chu Lai – đóng hàng HSQN- hạ Chu Lai.",
        "customer": "VANTUONG",
        "cargoType": "VC_CONT",
        "isNightStay": false,
        "revenue": {
...
function calculatePriority(ticket) {
    ...
    // 2. Waiting Pressure (weight 0.25)
    ...
    // 3. Chaining Opportunity (weight 0.15) — simplified for Phase 1
    let chainingOpportunity = 30; // default
    
    const score = Math.round(
        pickupUrgency * 0.60 +
        waitingPressure * 0.25 +
        chainingOpportunity * 0.15
    );
    ...
    return {
        score,
        level,
        breakdown: { pickupUrgency, waitingPressure, chainingOpportunity }
    };
}
...
function scoreDriver(driver, ticket, db) {
    ...
    // 1. Continuity Score (weight 0.40) — area_code based
    ...
    // 4. Performance Score (weight 0.10) — Phase 1 default
    let performance = 50;
