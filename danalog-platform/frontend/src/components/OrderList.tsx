                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left whitespace-nowrap">
                        <thead className="bg-slate-50 border-b border-slate-200">
                            <tr>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs w-12 text-center">STT</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs">Mã đơn</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs">Khách hàng</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs">Tuyến đường</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs text-center">Ngày lấy hàng</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs text-center">Container</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs text-center">Số phiếu</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs text-center">Trạng thái</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs">Người tạo</th>
                                <th className="px-5 py-4 font-bold text-slate-500 uppercase tracking-wider text-xs text-center">Thao tác</th>
                            </tr>
                        </thead>
